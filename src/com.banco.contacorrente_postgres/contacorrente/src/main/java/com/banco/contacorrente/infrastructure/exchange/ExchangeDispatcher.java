...
import com.banco.contacorrente.model.creditorotativo.LimiteCreditoAlterado;
...
public class ExchangeDispatcher implements Dispatcher<Dispatchable<Entry<String>, State<String>>>, ConfirmDispatchedResultInterest {
  ...
  public ExchangeDispatcher(final Exchange ...producerExchanges) {
    this.eventsByExchangeName.put("limitealterado-topic", new HashSet<>());
    this.eventsByExchangeName.get("limitealterado-topic").add(LimiteCreditoAlterado.class.getCanonicalName());
