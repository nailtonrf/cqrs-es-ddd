 ...
 */
public class CreditoRotativoProducerAdapter implements ExchangeAdapter<IdentifiedDomainEvent, IdentifiedDomainEvent, Message> {

  private static final String SCHEMA_PREFIX = "banco:contacorrente:creditorotativo";
